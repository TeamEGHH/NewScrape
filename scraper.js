...
Scraper.prototype.parsePage = function (html) {
    ...
    */
    ...
    //sama hatt.
    //Fær svo sjálfkrafa "annnad" tag ef ekkert passaði.
    function getTags() {
        var tags = [];
        var groups = {
            innlent  : ["/frettir/innlent", "/FRETTIR01"],
            erlent   : ["/FRETTIR02", "/frettir/erlent"],
            sport    : ["/sport", "/IDROTTIR"],
            politik  : ["/frettir/stjornmal", "/althingi"],
            taekni   : ["/frettir/teakni", "/frettir/togt"],
            vidskipti: ["/vidskipti", "/VIDSKIPTI", "/frettir/vidskipti"],
            musik    : ["/musik", "/LIFID02"],
            folk  : ["/folk", "/LIFID"]
        }
